function testSixMarshalString() {
	var context = new Jsonix.Context([ Five, Six ]);
...
function testSixUnmarshalString() {
	var context = new Jsonix.Context([ Five, Six ]);
...
function testFiveMarhshalValueType() {
	var context = new Jsonix.Context([ Five ]);
	var marshaller = context.createMarshaller();
	var value = {
		name : {
...
function testFiveUnmarshalValueType() {
	var context = new Jsonix.Context([ Five ]);
	var unmarshaller = context.createUnmarshaller();
...
function testFiveMarhshalAnyAttributeType() {
	var context = new Jsonix.Context([ Five ], {
		namespacePrefixes : {
			'urn:b' : 'b'
		}
...
function testFiveUnmarhshalAnyAttributeType() {
	var context = new Jsonix.Context([ Five ]);
	var unmarshaller = context.createUnmarshaller();
...
function testFiveMarhshalAttributeType() {
	var context = new Jsonix.Context([ Five ], {
		namespacePrefixes : {}
	});
	var marshaller = context.createMarshaller();
...
function testFiveUnmarshalAttributeType() {
	var context = new Jsonix.Context([ Five ]);
	var unmarshaller = context.createUnmarshaller();
...
function testFiveMarhshalElementType() {
	var context = new Jsonix.Context([ Five ]);
	var marshaller = context.createMarshaller();
	var value = {
		name : {
...
function testFiveUnmarhshalElementType() {
	var context = new Jsonix.Context([ Five ]);
	var unmarshaller = context.createUnmarshaller();
	var text = '<element>' +
	//
...
function testFiveMarhshalElementsType() {
	var context = new Jsonix.Context([ Five ]);
	var marshaller = context.createMarshaller();
	var value = {
		name : {
...
function testFiveUnmarhshalElementsType() {
	var context = new Jsonix.Context([ Five ]);
	var unmarshaller = context.createUnmarshaller();
	var marshaller = context.createMarshaller();
	var text = '<elements>' +
...
function testFiveUnmarshalElementRefType() {
	var context = new Jsonix.Context([ Five ]);
	var unmarshaller = context.createUnmarshaller();
	var text = '<elementRef>' +
	//
...
function testFiveUnmarshalElementRefsType() {
	var context = new Jsonix.Context([ Five ]);
	var unmarshaller = context.createUnmarshaller();
...
function testFiveMarhshalAnyElementType() {
	var context = new Jsonix.Context([ Five, Six ]);
	var marshaller = context.createMarshaller();
	var value = {
		name : {
...
function testFiveUnmarhshalAnyElementType() {
	var context = new Jsonix.Context([ Five, Six ]);
	var unmarshaller = context.createUnmarshaller();
...
function testFiveMarhshalSimpleTypesType() {
	var context = new Jsonix.Context([ Five ]);
	var marshaller = context.createMarshaller();
	var value = {
		name : {
...
function testFiveUnmarhshalSimpleTypesType() {
	var context = new Jsonix.Context([ Five ]);
	var unmarshaller = context.createUnmarshaller();
...
function testFiveUnmarhshalMapElementType() {
	var context = new Jsonix.Context([ Five ]);
	var unmarshaller = context.createUnmarshaller();
	var text = '<elementMap>' +
	//
...
function testFiveMarhshalMapElementType() {
	var context = new Jsonix.Context([ Five ]);
	var marshaller = context.createMarshaller();
	var value = {
		name : {
...
function testFiveUnmarhshalEnumInfoArrayType() {
	var context = new Jsonix.Context([ Five ]);
	var unmarshaller = context.createUnmarshaller();
...
function testFiveUnmarhshalEnumInfoObjectType() {
	var context = new Jsonix.Context([ Five ]);
	var unmarshaller = context.createUnmarshaller();
...
function testFiveUnmarhshalStringEnumInfoArrayType() {
	var context = new Jsonix.Context([ Five ]);
	var unmarshaller = context.createUnmarshaller();
...
function testFiveUnmarhshalIntegerEnumInfoArrayType() {
	var context = new Jsonix.Context([ Five ]);
	var unmarshaller = context.createUnmarshaller();
...
function testFiveUnmarhshalIntegerEnumInfoObjectType() {
	var context = new Jsonix.Context([ Five ]);
	var unmarshaller = context.createUnmarshaller();
...
function testFiveMarhshalEnumInfoArrayType() {
	var context = new Jsonix.Context([ Five ]);
	var marshaller = context.createMarshaller();
	var value = {
		name : {
...
function testFiveMarhshalEnumInfoObjectType() {
	var context = new Jsonix.Context([ Five ]);
	var marshaller = context.createMarshaller();
	var value = {
		name : {
...
function testFiveMarhshalStringEnumInfoArrayType() {
	var context = new Jsonix.Context([ Five ]);
	var marshaller = context.createMarshaller();
	var value = {
		name : {
...
function testFiveMarhshalStringEnumInfoObjectType() {
	var context = new Jsonix.Context([ Five ]);
	var marshaller = context.createMarshaller();
	var value = {
		name : {
...
function testFiveMarhshalIntegerEnumInfoArrayType() {
	var context = new Jsonix.Context([ Five ]);
	var marshaller = context.createMarshaller();
	var value = {
		name : {
...
function testFiveMarhshalIntegerEnumInfoObjectType() {
	var context = new Jsonix.Context([ Five ]);
	var marshaller = context.createMarshaller();
	var value = {
		name : {
